  ...
  async itinerary(itineraryArr: number[]) {
    ...
    const getItinerary = async (travel_id: number) => {
      ...
      result_Arr.push({
        ...
        travel_title_1: data.travel_title_1,
        travel_title_2: data.travel_title_2,
    ...
    try {
      ...
      await tempTable.create({
        schema: {
          fields: [
            ...
            { name: 'travel_title_1', type: 'STRING', mode: 'NULLABLE' },
            { name: 'travel_title_2', type: 'STRING', mode: 'NULLABLE' },
      ...
      WHEN MATCHED THEN
        UPDATE SET
          ...
          travel_title_1 = source.travel_title_1,
          travel_title_2 = source.travel_title_2,
